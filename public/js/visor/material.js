...
var materialTypeWireFrame_selected = new THREE.MeshPhongMaterial({ color: 0xFF6E6E, transparent: true, opacity: 0.5 });
...
var materialTypeSolid_selected = new THREE.MeshPhongMaterial({ color: 0xFF6E6E, shininess:10 });
